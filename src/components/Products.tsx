...
export default function Products() {
  ...
  return (
    <section id="products" className="py-12 sm:py-20 bg-gradient-to-br from-cyan-50 via-emerald-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-2xl sm:text-3xl font-bold text-center text-cyan-900 mb-8 sm:mb-12">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {products.map((product) => (
            <div 
              key={product.id} 
              className="bg-white/80 backdrop-blur-sm rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col border border-white/20"
            >
              ...
              <div className="p-4 sm:p-6 flex flex-col flex-grow">
                <h3 className="text-lg sm:text-xl font-semibold text-cyan-900 mb-2">{product.name}</h3>
                  ...
                  <button
                    ...
                    className={`w-full sm:w-auto flex items-center justify-center space-x-2 px-4 py-2.5 rounded-full text-sm sm:text-base font-medium transition-all duration-200 ${
                      addedToCart[product.id]
                        ...
                        : 'bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 active:from-cyan-700 active:to-blue-700 text-white'
                    }`}
                  >
                    {addedToCart[product.id] ? (
                      <>
